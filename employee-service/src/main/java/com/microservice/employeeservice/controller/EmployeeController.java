...
public class EmployeeController {
    ...
    @Operation(
            ...
            description = "Save Employee REST API is used to save the employee object to db"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Employee REST API is used to get the employee object from db"
    )
    @ApiResponse(
            responseCode = "200",
