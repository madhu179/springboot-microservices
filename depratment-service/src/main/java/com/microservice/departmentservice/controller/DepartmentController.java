...
public class DepartmentController {
    ...
    @Operation(
            ...
            description = "Save Department REST API is used to save a department object to db"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Department REST API is used to get a department object from db"
    )
    @ApiResponse(
            responseCode = "200",
